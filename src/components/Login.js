...
const Login = () => {
  ...
  .then((userCredential) => {
    ...
    updateProfile(user, {
      ...
      photoURL: "https://media.licdn.com/dms/image/D4D03AQEqasnaAstPxg/profile-displayphoto-shrink_800_800/0/1691063611366?e=1709164800&v=beta&t=IicXqr5KLmZ9p3r6G9rLEjCavQjOb4BDjNJIQMF_EDs"
    })
     .then(() => {
